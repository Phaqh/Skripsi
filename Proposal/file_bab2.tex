...
Secara keseluruhan, literatur menunjukkan keberagaman pendekatan dalam memodelkan dan merespons dinamika perilaku lawan, baik melalui pembelajaran eksplisit, mekanisme kopling lingkungan, maupun adaptasi berbasis populasi. Namun demikian, fokus evaluasi dalam studi-studi tersebut umumnya diarahkan pada peningkatan reward, stabilitas kerja sama, atau konvergensi, sehingga membuka ruang analisis lebih lanjut mengenai hubungan antara kualitas prediksi perilaku lawan dan implikasinya terhadap perencanaan strategis lintas-horizon.
...
Literatur yang sepenuhnya memisahkan pembelajaran model lawan dari sinyal reward kebijakan masih relatif terbatas, khususnya dalam konteks \textit{repeated games} dengan lawan adaptif dan tidak stasioner.
