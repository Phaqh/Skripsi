...
\midrule
Implementasi protokol pelatihan satu langkah & & & & \checkmark & \checkmark & & & \\
\midrule
Implementasi pelatihan multi langkah (k=5,10 + ROC) & & & & & \checkmark & \checkmark & & \\
\midrule
Evaluasi terpisah (Confusion Matrix, NLL, CE) & & & & & & \checkmark & & \\
\midrule
Evaluasi terpasang (Multi-step, Regret, Reward) & & & & & & \checkmark & \checkmark & \\
\midrule
