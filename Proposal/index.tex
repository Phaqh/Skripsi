...
%-----------------------------------------------------------------
\titleind{Pemodelan Lawan Belajar Menggunakan Nonlinear AutoRegressive with eXogenous Input (NARX) pada Iterated Prisoner's Dilemma dengan Horizon Terbatas}

\titleeng{ Learning Opponent Modelling using a Nonlinear AutoRegressive with eXogenous Input (NARX) Model in the Iterated Prisoner's Dilemma with a Bounded Horizon }
