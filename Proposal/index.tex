...
%-----------------------------------------------------------------
\titleind{Pemodelan Lawan Berbasis Forecasting Multi-Langkah yang Terpisah dari Optimisasi Reward pada Iterated Prisoner's Dilemma}

\titleeng{Multi-Step Forecasting-Based Opponent Modelling Decoupled from Reward Optimization in the Iterated Prisoner's Dilemma}
