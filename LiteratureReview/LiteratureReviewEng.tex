...
\begin{itemize}
    \item \textbf{Irrelevant focus:} The study does not address opponent modelling, opponent-aware adaptation, or reasoning about other agents, or focuses exclusively on one-shot games without repeated interaction.
    
    \item \textbf{Generic multi-agent learning:} The study applies multi-agent reinforcement learning or learning-in-games techniques without incorporating opponent-aware adaptation, either explicitly or implicitly, through action conditioning, belief updates, or history-dependent response mechanisms.
...
Reviews recursive modeling frameworks.\\ \hline
...
\cite{doshi_recursively_2020} & No training performed & Not applicable \\
