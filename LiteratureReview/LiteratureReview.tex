...
\begin{itemize}
    \item \textbf{RQ1:} What environmental settings and monitoring mechanisms are used in opponent modelling for the Iterated Prisoner's Dilemma, and what are their advantages and disadvantages?
    \item \textbf{RQ2:} What methodological approaches to opponent modelling have been applied in the Iterated Prisoner's Dilemma, and what strengths and limitations characterize them?
...
-- & -- & \checkmark & \checkmark & Learning Opponent & \cite{qiao_o2m_2024}, \cite{lv_inducing_2023}, \cite{doshi_recursively_2020}, \cite{li_exploiting_2025}, \cite{freire_modeling_2023}, \cite{hu_modeling_2023}, \cite{wang_achieving_2019}, \cite{de_weerd_higher-order_2022} \\
\addlinespace
