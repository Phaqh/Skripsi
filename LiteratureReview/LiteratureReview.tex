...
integrates findings across these perspectives to identify persistent limitations and articulate the research gap.
...
[Environment \\ Game Assumptions, header
  [Evolutionary, header 
    [Multi-agent \\ Fixed Group
      [non-stationary \\ \textit{(P2)}, citation]
      [Population dynamic \\ \textit{(P8)}, citation]
    ]
    [Population / Networked
      [Population dynamic \\ \textit{(P13)}, citation]
    ]
  ]
  [Sequential / Iterated
    [Dyadic
      [non-stationary \\ \textit{(P1)}, citation]
    ] 
    [Multi-agent \\ Fixed Group
      [non-stationary \\ \textit{(P11, P14)}, citation]
    ]
    [Population / Networked
      [non-stationary \\ \textit{(P3, P4, P9, P10, P12, )}, citation]
      [Population dynamic \\ \textit{(P7)}, citation]
    ]
  ]
  [One-Shot, header
    [Multi-agent \\ Fixed Group
      [stationary \\ \textit{(P5, P6)}, citation]
      [non-stationary \\ \textit{(P15)}, citation]
    ]
  ]
]
\end{forest}
\caption{Taxonomy of environment and game assumptions in opponent modelling literature.}
\label{fig:env-taxonomy}
\end{figure*}


\section{Proposed framework}
my thesis pro[posed framework.]
